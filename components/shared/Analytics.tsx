 ...
 * check never passes: view_item, add_to_cart, begin_checkout and
 * booking_confirmed all silently do nothing, and the failure looks EXACTLY
 * like a working site. The server-side generate_lead from /api/register keeps
 * reporting through the Measurement Protocol, which makes the gap harder to
 * spot rather than easier: GA4 shows leads with no funnel above them.
 *
 ...
 * paint, and the first event this site fires (view_item) is dispatched from
